 ...
 * This file demonstrates how to integrate Assetglyph with a web frontend
 */

// For React/Vue/Angular applications
export class AssetglyphClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new AssetglyphClient(provider, contractAddress);
